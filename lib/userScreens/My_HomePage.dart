            ...
            new IconButton(icon: new Icon(Icons.favorite),
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => My_Favorite()));
                }
            ),
        ...
        floatingActionButton: new Stack(
          ...
          children: <Widget>[
            ...
            new CircleAvatar(
              ...
              backgroundColor: Colors.redAccent,
              child: new Text(
                "0", style: TextStyle(color: Colors.white, fontSize: 12.0),),
            )
          ],
        ),
                        ...
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder:
                              ...
                              My_ItemDetails(
                                ...
                                itemDescription: StoreItems[index]
                                    .itemDescription,
                              )));
                        },
                        child: new Card(
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  new IconButton(icon: Icon(
                                    Icons.favorite_border, size: 25.0,
                                    color: Colors.red,),
                                      onPressed: () {}),
                                ],
                              ),
